...
Read data using a RStudio project directory (assumes you have a project folder with subfolders called "notebooks" for your notebooks/scripts and another subfolder called "data").
