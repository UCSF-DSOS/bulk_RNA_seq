...
```
**Think:** why is there that peak on the left side of the raw data? Recall the `cpm` function in chunk #6. Use `?cpm` - check input values and how they are handled by default.

### Normalize data
```{r narmalization *edit to affect analysis*}
